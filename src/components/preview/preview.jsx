        ...
        <>
            <div className="flex justify-center">
                <div className="container max-w-[1000px]">
                    ...
                    {/* Live Streaming */}
                    <div className='mt-16 px-12 rounded-xl py-4' style={{ boxShadow: shadow }}>
                            ...
                            <div className='flex gap-6'>
                                ...
                                >
                                    <div className='px-2 py-2'>
                                        <MultiCarousel responsive={responsiveB} showDots={true} removeArrowOnDeviceType={["tablet", "mobile", "desktop"]}>
                                            <div className='flex justify-center'>
                                                <img src={Img3} />
